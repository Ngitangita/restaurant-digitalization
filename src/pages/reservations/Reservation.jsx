...
function ReservationList() {
  ...
  const fetchReservations = async () => {
    setIsLoading(true);
    try {
      const [reservationsResponse, roomsResponse, customersResponse, statusesResponse, tablesResponse] = await Promise.all([
      ...
      if (!reservationsResponse.ok || !roomsResponse.ok || !tablesResponse.ok || !customersResponse || !statusesResponse.ok) {
        throw new Error('Erreur lors de la récupération des chambres, clients ou statuts, tables');
      }
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="DeleteModal bg-white p-6 rounded-lg shadow-lg w-[400px] text-center">
            <p className="mb-6">Êtes-vous sûr de vouloir supprimer la réservation du
              Mme/Mr {reservationToDelete?.customer.lastName} ?</p>
