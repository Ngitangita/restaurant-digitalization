export default function CreateCategorie() {
  return (
    <div className="flex justify-center items-center">
      <div className="flex justify-center items-center flex-col bg-white dark:bg-black rounded p-5 text-gray-500">
        <div className="flex flex-col gap-4 items-center">
          <div className="flex flex-row gap-3 items-center">
            ...
            <div className='flex flex-col'>
              ...
              <span className='text-xs'>Ankasina Antananarivo <br /> Tél: 038 96 373 43</span>
            </div>
          </div>
          <h1 className="text-2xl font-bold underline">Créer des menus</h1>
        </div>
        <form className="flex flex-col justify-center gap-4 p-4 text-gray-700 rounded bg-white">
          <div className="flex flex-row justify-between items-center">
            ...
            <input type="text" id="titre"
              placeholder="titre"
              className="w-72 pl-4 pr-2 py-1 bg-slate-300 bg-opacity-15 rounded outline-none " />
          </div>
          <div className="flex flex-row justify-between items-center">
